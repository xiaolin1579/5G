...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " 5g-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  5g-tx [options] <hex-tx> [commands]  Update hex-encoded 5g transaction\n" +
            "or:     5g-tx [options] -create [commands]   Create hex-encoded 5g transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded 5g transaction
