...
{
    return QCoreApplication::translate("5g-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. 5g_de.qm (shortcut "de" needs to be defined in 5g.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. 5g_de_DE.qm (shortcut "de_DE" needs to be defined in 5g.qrc)
...
/** Class encapsulating 5G startup and shutdown.
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. 5G can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data and blocks directory and parse 5g.conf
    ...
    // 5g: links repeatedly have their payment requests routed to this process:
