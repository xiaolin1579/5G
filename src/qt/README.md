This directory contains the 5GQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the 5G UI.
...
ClientModel is used by the main application `5ggui` and several models like `peertablemodel`.
...
Used to process BIP21 and BIP70 (see https://github.com/5g/5g/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a 5g:... link from a browser).
...
* `5gstrings.cpp`: automatically generated
* `5gunits.(h/cpp)`: 5G / m5G / etc handling
* `callback.h`
...
* don't change `local/5g_en.ts`; this happens [automatically](/doc/translation_process.md#writing-code-with-translations)
...
4. Enter "5g-qt" as project name, enter src/qt as location
5. Leave the file selection as it is
6. Confirm the "summary page"
7. In the "Projects" tab select "Manage Kits..."
8. Select the default "Desktop" kit and select "Clang (x86 64bit in /usr/bin)" as compiler
9. Select LLDB as debugger (you might need to set the path to your installation)
10. Start debugging with Qt Creator (you might need to the executable to "5g-qt" under "Run", which is where you can also add command line arguments)
