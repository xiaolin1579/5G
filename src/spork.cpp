...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 1000;         // 1000 5G
...
static const int64_t SPORK_55_MASTERNODE_MULTIPORT_DEFAULT              = 4070908800ULL;// OFF
}
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        case SPORK_55_MASTERNODE_MULTIPORT_ENABLED:     r = SPORK_55_MASTERNODE_MULTIPORT_DEFAULT; break;
        default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    case SPORK_55_MASTERNODE_MULTIPORT_ENABLED:     return SPORK_55_MASTERNODE_MULTIPORT_DEFAULT;
    default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_55_MASTERNODE_MULTIPORT_ENABLED")     return SPORK_55_MASTERNODE_MULTIPORT_ENABLED;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    ...
    case SPORK_55_MASTERNODE_MULTIPORT_ENABLED:     return "SPORK_55_MASTERNODE_MULTIPORT_ENABLED";
    default:
